...
const tags = document.querySelectorAll(".section__heading, .section__subheading, .services__card, .blog-card, .cta__subheading, .cta__heading, .clickable-title, .right-column, .clickables-heading, .vision__lock-up, .contact-card")
tags.forEach((tag) => {
